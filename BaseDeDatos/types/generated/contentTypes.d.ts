...
export interface ApiHabitacionHabitacion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    elementos_habitacion: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    stock_habitacion: Schema.Attribute.Relation<
      'oneToOne',
      'api::stock-habitacion.stock-habitacion'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPersonaPersona extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    direccion_calles: Schema.Attribute.String;
    direccion_localidades: Schema.Attribute.String;
    direccion_numero: Schema.Attribute.String;
    direccion_provincias: Schema.Attribute.String;
    dni_persona: Schema.Attribute.String;
...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    stock_habitacion: Schema.Attribute.Relation<
      ...
      'api::stock-habitacion.stock-habitacion'
    >;
    stock_habitacion_productos: Schema.Attribute.Relation<
      'oneToMany',
      'api::stock-habitacion-producto.stock-habitacion-producto'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiReservaReserva extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cant_personas: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    fecha_de_entrada: Schema.Attribute.Date;
    fecha_de_salida: Schema.Attribute.Date;
    habitacion: Schema.Attribute.Relation<
      'manyToOne',
      'api::habitacion.habitacion'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    personas: Schema.Attribute.Relation<'oneToMany', 'api::persona.persona'>;
    publishedAt: Schema.Attribute.DateTime;
    tipo: Schema.Attribute.Enumeration<['Booking', 'Pagina Web', 'otro']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiStockHabitacionProductoStockHabitacionProducto
  extends Struct.CollectionTypeSchema {
...
export interface ApiStockHabitacionStockHabitacion
  extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::stock-habitacion-producto.stock-habitacion-producto': ApiStockHabitacionProductoStockHabitacionProducto;
      'api::stock-habitacion.stock-habitacion': ApiStockHabitacionStockHabitacion;
